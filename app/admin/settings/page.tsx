...
const DEFAULT_SETTINGS = {
  ...
  freeAiGenerationsPerDay: 3,
  premiumAiGenerationsPerDay: 50,
  contactPhone: "+216 24 268 377",
};
...
export default function AdminSettingsPage() {
  ...
  return (
    <>
      ...
      <div className="admin-settings-section">
        ...
        <div className="admin-settings-card">
          ...
          <div className="admin-settings-toggle">
            <div>
              <label className="admin-settings-label">
                Autoriser de nouveaux magasins
              </label>
              <p className="admin-settings-hint">
                Permettre aux utilisateurs de créer de nouveaux magasins
              </p>
            </div>
            <button
        ...
        <div className="admin-settings-card">
          <div className="admin-settings-toggle">
            <div>
              ...
              <p className="admin-settings-hint">
                Mettre le site en mode maintenance (seuls les admins peuvent
                accéder)
              </p>
            </div>
            <button
        ...
        <div className="admin-settings-card">
          ...
          <div className="admin-settings-toggle">
            <div>
              ...
              <p className="admin-settings-hint">
                Activer les notifications par SMS pour les administrateurs
              </p>
            </div>
            <button
      ...
      <div className="admin-settings-section">
        <h2 className="admin-settings-section-title">Génération IA</h2>
        <div className="admin-settings-card">
          <div className="admin-settings-field">
            <label className="admin-settings-label">
            ...
            <input
              type="number"
              className="admin-settings-input"
              value={settings.freeAiGenerationsPerDay}
              onChange={(e) =>
                handleInputChange(
            ...
            />
            <p className="admin-settings-hint">
              Nombre de générations offertes à chaque utilisateur gratuit par
              jour
            </p>
          </div>
          ...
          <div className="admin-settings-field">
            <label className="admin-settings-label">
              Générations premium par jour (global)
            </label>
            <input
              type="number"
              className="admin-settings-input"
              value={settings.premiumAiGenerationsPerDay}
              onChange={(e) =>
                handleInputChange(
            ...
            />
            <p className="admin-settings-hint">
              Limite quotidienne pour les utilisateurs premium (modifiable par
          ...
          <div className="admin-settings-field">
            <label className="admin-settings-label">
              Numéro de contact (upgrade premium)
            </label>
            <input
              type="text"
              className="admin-settings-input"
            ...
            />
            <p className="admin-settings-hint">
              Numéro affiché aux utilisateurs qui souhaitent passer au plan
              premium
            </p>
          </div>
        </div>
