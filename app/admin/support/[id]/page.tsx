...
export default async function AdminTicketDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="support-detail-page">
            <div className="support-detail-header">
                ...
                <div className="support-detail-meta">
                    ...
                    <span className="support-detail-date">
                        Créé le {format(ticket.createdAt, "dd/MM/yyyy à HH:mm")} par {ticket.user.email}
                    </span>
                </div>
            </div>
                            ...
                            <div className="support-message-author-badge">
                                {message.isAdmin ? (
                                    <>
                                        ...
                                        <span className="support-message-author-label">Vous (Support)</span>
                                    </>
                                ) : (
                                    <>
                                        <span className="support-message-icon">👤</span>
                                        <span className="support-message-author-label">{ticket.user.email}</span>
                                    </>
                                )}
                            </div>
            ...
            <TicketResponseForm ticketId={ticket.id} currentStatus={ticket.status} />
        </div>
    );
}
