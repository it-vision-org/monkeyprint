        ...
        <div className="dashboard-page">
            ...
            <header className="dash-header">
                    ...
                    <div className="dash-logo">
                        DASHBOARD <span className="dash-pipe">|</span> <span className="dash-section">PRODUITS</span>
                    </div>
            ...
            <main className="dash-main">
                <div className="dash-container">
                    <div className="dash-title-row">
                        <h1 className="dash-page-title">Liste de produits</h1>
                        ...
                        {products.map((product, index) => (
                            <div key={index} className={`produit-card ${index === 1 ? 'selected' : ''}`}>
                                ...
                                <div className="produit-image-container">
                                    <Image src="/mock-shirt.png" alt={product.name} width={180} height={180} style={{ objectFit: 'contain' }} />
                                </div>
                                ...
                                <div className="produit-info">
                                    ...
                                    <div className="produit-rating">
                                        {[...Array(5)].map((_, i) => (
                                            <svg key={i} width="18" height="18" viewBox="0 0 24 24" fill={i < product.rating ? "#FFA500" : "#E5E7EB"} xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="produit-sold-badge">
                                        <span className="produit-emoji">😊</span>
