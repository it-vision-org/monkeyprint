...
export default function ProductUploadHeader({
    ...
    const MobilePriceBar = () => (
        <div className={`${styles['pu-cart-container']} ${styles['pu-cart-container-mobile']}`}>
            <button
            ...
            {showPriceDetails && mobilePriceExpanded && (
                <div className={`${styles['pu-cart-details']} ${styles['pu-cart-details-mobile']}`}>
                    ...
                    <div className={styles['pu-cart-items']}>
                        {defaultCartItems.map((item, index) => (
                            <div key={index} className={styles['pu-cart-item']}>
                                ...
                                <span className={styles['pu-cart-item-price']}>{item.price}DT</span>
                            </div>
                        ))}
                    </div>
                    <div className={styles['pu-cart-total-line']}>
                        <span className={styles['pu-cart-total-label']}>Total</span>
                        <span className={styles['pu-cart-total-price']}>{totalPrice}DT</span>
                    </div>
                </div>
            )}
        </div>
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <div className={styles['pu-price-widget-trigger-price']}>{totalPrice}DT</div>
                </button>
                ...
                <div className={styles['pu-price-widget-panel']}>
                    <div className={styles['pu-price-widget-header']}>
                        ...
                        <div className={styles['pu-price-widget-header-title']}>Récapitulatif</div>
                    </div>
                            ...
                            {defaultCartItems.map((item, index) => (
                                <div key={index} className={styles['pu-price-widget-item']}>
                                    <div className={styles['pu-price-widget-item-info']}>
                                        <div className={styles['pu-price-widget-item-icon']}>{item.icon}</div>
                                        <span className={styles['pu-price-widget-item-label']}>{item.label}</span>
                                    </div>
                                    <span className={styles['pu-price-widget-item-price']}>{item.price}DT</span>
                                </div>
                            ))}
                        </div>
                        <div className={styles['pu-price-widget-total']}>
                            <div className={styles['pu-price-widget-total-label']}>Total</div>
                            <div className={styles['pu-price-widget-total-price']}>{totalPrice}DT</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <header className={styles['pu-header']}>
                <div className={styles['pu-header-inner']}>
                    <div className={styles['pu-logo-container']}>
                        ...
                        <span className={styles['pu-logo-text']}>MONKEY PRINT</span>
                    </div>
                    <nav className={styles['pu-desktop-nav']}>
                        {hasStore ? (
                            <>
                                <Link href="/dashboard/apercu" className={styles['pu-desktop-nav-link']}>APERÇU</Link>
                                <Link href="/dashboard/produits" className={styles['pu-desktop-nav-link']}>PRODUITS</Link>
                                <Link href="/dashboard/commandes" className={styles['pu-desktop-nav-link']}>COMMANDES</Link>
                                <Link href="/dashboard/portefeuille" className={styles['pu-desktop-nav-link']}>PORTEFEUILLE</Link>
                                <Link href="/dashboard/compte" className={styles['pu-desktop-nav-link']}>COMPTE</Link>
                            </>
                        ) : (
                            <>
                                <a href="/" className={styles['pu-desktop-nav-link']}>Accueil</a>
                                <a href="/#stores" className={styles['pu-desktop-nav-link']}>Shop List</a>
                                <a href="/contact" className={styles['pu-desktop-nav-link']}>Contactez-nous</a>
                            </>
                        )}
                    </nav>
                    <button
            ...
            {mobileMenuOpen && (
                <div className={mpStyles['mp-mobile-overlay']} onClick={() => setMobileMenuOpen(false)}>
                    <div className={styles['pu-mobile-sheet']} onClick={(event) => event.stopPropagation()}>
                        <button className={styles['pu-mobile-close']} type="button" onClick={() => setMobileMenuOpen(false)}>
                            ×
                        </button>
