...
export default function AllProductsTheme3() {
    ...
    return (
        <div className="all-products-page all-products-dark">
                ...
                <div className="theme-3-container">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <button className="theme-3-cart-btn" onClick={() => router.push('/store/theme-3/cart')}>
                            ...
                            <span className="theme-3-cart-badge">1</span>
                        </button>
                        <button className="theme-3-menu-btn" onClick={() => router.push('/store/theme-3')}>
            ...
            <main className="all-products-main">
                ...
                <div className="all-products-grid">
                    {products.map((product, index) => (
                        <div key={index} className="all-products-card" onClick={() => router.push('/store/theme-3/product/1')}>
