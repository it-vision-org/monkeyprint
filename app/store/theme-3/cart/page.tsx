    ...
    return (
        <div className="cart-page">
            <header className="cart-top-header">
                <div className="cart-top-header-inner">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <button className="cart-top-cart-btn" onClick={() => router.push('/store/theme-3/cart')}>
            ...
            <div className="cart-container">
                            ...
                            <div className="cart-item-details">
                                ...
                                <div className="cart-item-rating">
                                    ...
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                                        <defs>
                                            <linearGradient id="half-star-cart-3" x1="0%" y1="0%" x2="100%" y2="0%">
                                                <stop offset="50%" stopColor="#FFD700" />
                                                <stop offset="50%" stopColor="#E5E7EB" />
                                            </linearGradient>
                                        </defs>
                                        <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="url(#half-star-cart-3)"/>
                                    </svg>
                                </div>
                ...
                <button className="cart-checkout-btn" onClick={() => router.push('/store/theme-3/checkout')}>
