                ...
                <div className="theme-1-container">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <button className="theme-1-cart-btn" onClick={() => router.push('/store/theme-1/cart')}>
                            ...
                            <span className="theme-1-cart-badge">1</span>
                        </button>
                        <button className="theme-1-menu-btn" onClick={() => router.push('/store/theme-1')}>
            ...
            <main className="all-products-main">
                ...
                <div className="all-products-grid">
                    {products.map((product, index) => (
                        <div key={index} className="all-products-card" onClick={() => router.push('/store/theme-1/product/1')}>
