    ...
    return (
        <div className="product-detail-page">
            ...
            <div className="product-detail-footer">
                <button className="product-cart-icon-btn" onClick={() => router.push('/store/theme-1/cart')}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <button className="product-add-to-cart-btn" onClick={() => router.push('/store/theme-1/cart')}>
